...
export const getMonthRangeWeight = async (weightInfo) => {
  ...
  try {
    const { data } = await fetchDataGet('/record/getMonthRangeWeight', {
      params: weightInfo,
    });
    return data;
  } catch (err) {
...
export const getWeight = async (weightInfo) => {
  ...
  try {
    const { data } = await fetchDataGet('/record/getWeight', {
      params: weightInfo,
    });
    return data;
  } catch (err) {
...
export const getPredictWeight = async (userCode) => {
  try {
    const { data } = await fetchDataGet('/record/getPredictWeight', {
      params: userCode,
    });
    return data;
  } catch (e) {
